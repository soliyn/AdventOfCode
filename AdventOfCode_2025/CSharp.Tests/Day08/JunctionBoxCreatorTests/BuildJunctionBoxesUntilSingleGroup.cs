...
public class BuildJunctionBoxesUntilSingleGroup
{
    [Fact]
    public void Should_Return_Expected_Value()
    {
        ...
        var lastPair = JunctionBoxCreator.BuildJunctionBoxesUntilSingleGroup(points);
        Assert.Equal(25272, lastPair.A.X * lastPair.B.X);
    }
}